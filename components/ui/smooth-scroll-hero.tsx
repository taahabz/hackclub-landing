        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Join thousands of coders worldwide who've found their community,
              <br className="hidden md:block" />
              pushed their skills, and discovered what they're truly capable of building.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Active Members</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Events Hosted</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Workshops Held</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Projects Built</div>
              </div>
            </div>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">TRUSTED BY CODERS AT NUST</p>
